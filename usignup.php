...
<head>
  ...
  function validation()
  {
    ...
    <div class="row">
        ...
        <h1 ><br><strong><span >S</span></strong>ign Up</h1><br><i>Already have an account?</i><a href="usignin.php"> Sign In</a>
        <form action="usubmit.php" method="post" enctype="multipart/form-data">
        	<table class="table table-responsive">
        		<tr>
        			<td>User Name</td>
        		    <td><input type="text" name="name" id="n" class="form-control" ></td>
        		</tr>
                <tr>
                    <td>Email Address</td>
        		 ...
        		 <tr>
                    <td>Password</td>
                    <td><input type="password" name="password"  id="p"class="form-control"></td>
                </tr>
                 <tr>
                    <td>Mobile No</td>
                    <td><input type="tel" name="mobile" class="form-control" maxlength="10"></td>
                </tr>
               <tr>
...
<option>Zimbabwe</option>
                ...
                <tr>
                  ...
                  <td>  <input type="radio" name="gender" checked="checked" value="male" />Male
                    &nbsp;&nbsp;<input type="radio" name="gender"male" value="female"/>Female
                  </td>
                </tr>
